...
class LocationPermissionController(JavaClass, metaclass=MetaJavaClass):
    ...
    unsubscribe = JavaMultipleMethod([("(Lcom/onesignal/location/internal/permissions/ILocationPermissionChangedHandler;)V", False, False), ("(Ljava/lang/Object;)V", False, False)])
