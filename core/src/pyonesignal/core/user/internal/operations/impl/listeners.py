...
class SubscriptionModelStoreListener(JavaClass, metaclass=MetaJavaClass):
    ...
    getAddOperation = JavaMultipleMethod([("(Lcom/onesignal/common/modeling/Model;)Lcom/onesignal/core/internal/operations/Operation;", False, False), ("(Lcom/onesignal/user/internal/subscriptions/SubscriptionModel;)Lcom/onesignal/core/internal/operations/Operation;", False, False)])
