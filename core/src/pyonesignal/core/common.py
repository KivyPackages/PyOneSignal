...
class JSONObjectExtensionsKt(JavaClass, metaclass=MetaJavaClass):
    ...
    putMap = JavaMultipleMethod([("(Lorg/json/JSONObject;Ljava/util/Map;)Lorg/json/JSONObject;", True, False), ("(Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map;)Lorg/json/JSONObject;", True, False)])
