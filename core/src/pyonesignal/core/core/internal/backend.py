...
class RemoteLoggingParamsObject(JavaClass, metaclass=MetaJavaClass):
    ...
    __javaconstructor__ = [("()V", False), ("(Lcom/onesignal/debug/LogLevel;Z)V", False), ("(Lcom/onesignal/debug/LogLevel;ZILkotlin/jvm/internal/DefaultConstructorMarker;)V", False)]
