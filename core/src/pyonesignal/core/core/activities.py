...
class PermissionsActivity(JavaClass, metaclass=MetaJavaClass):
    __javaclass__ = "com/onesignal/core/activities/PermissionsActivity"
    ...
    access$getViewModel = JavaStaticMethod("(Lcom/onesignal/core/activities/PermissionsActivity;)Lcom/onesignal/core/internal/permissions/PermissionsViewModel;")
    access$finishActivity = JavaStaticMethod("(Lcom/onesignal/core/activities/PermissionsActivity;)V")
    access$handleBundleParams = JavaStaticMethod("(Lcom/onesignal/core/activities/PermissionsActivity;Landroid/os/Bundle;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;")