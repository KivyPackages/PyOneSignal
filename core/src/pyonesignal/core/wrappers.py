...
class IOneSignal(JavaClass, metaclass=MetaJavaClass):
    ...
    getUser = JavaMultipleMethod([("(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", False, False), ("()Lcom/onesignal/user/IUserManager;", False, False)])
    getSession = JavaMultipleMethod([("()Lcom/onesignal/session/ISessionManager;", False, False), ("(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", False, False)])
...
class OneSignal(JavaClass, metaclass=MetaJavaClass):
    ...
    initWithContext = JavaMultipleMethod([("(Landroid/content/Context;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", True, False), ("(Landroid/content/Context;Ljava/lang/String;)V", True, False)])
