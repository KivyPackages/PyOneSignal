...
class NotificationPermissionController(JavaClass, metaclass=MetaJavaClass):
    ...
    subscribe = JavaMultipleMethod([("(Lcom/onesignal/notifications/internal/permissions/INotificationPermissionChangedHandler;)V", False, False), ("(Ljava/lang/Object;)V", False, False)])
