...
class NotificationGenerationJob(JavaClass, metaclass=MetaJavaClass):
    ...
    __javaconstructor__ = [("(Lorg/json/JSONObject;Lcom/onesignal/core/internal/time/ITime;)V", False), ("(Lcom/onesignal/notifications/internal/Notification;Lorg/json/JSONObject;)V", False)]
