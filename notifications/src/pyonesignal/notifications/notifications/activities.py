...
class NotificationOpenedActivity(JavaClass, metaclass=MetaJavaClass):
    __javaclass__ = "com/onesignal/notifications/activities/NotificationOpenedActivity"
...
class NotificationOpenedActivityAndroid22AndOlder(JavaClass, metaclass=MetaJavaClass):
    __javaclass__ = "com/onesignal/notifications/activities/NotificationOpenedActivityAndroid22AndOlder"
    __javaconstructor__ = [("()V", False)]
    DEFAULT_KEYS_DIALER = JavaStaticField("I")
    DEFAULT_KEYS_DISABLE = JavaStaticField("I")
    DEFAULT_KEYS_SEARCH_GLOBAL = JavaStaticField("I")
...
class NotificationOpenedActivityBase(JavaClass, metaclass=MetaJavaClass):
    __javaclass__ = "com/onesignal/notifications/activities/NotificationOpenedActivityBase"
    __javaconstructor__ = [("()V", False)]
    DEFAULT_KEYS_DIALER = JavaStaticField("I")
    DEFAULT_KEYS_DISABLE = JavaStaticField("I")
    DEFAULT_KEYS_SEARCH_GLOBAL = JavaStaticField("I")
    ...
    WIFI_SERVICE = JavaStaticField("Ljava/lang/String;")
    WINDOW_SERVICE = JavaStaticField("Ljava/lang/String;")
    processIntent$com_onesignal_notifications = JavaMethod("()V")